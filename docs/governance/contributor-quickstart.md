...
- Check the [Architecture Overview](/developer/architecture) to understand how the system works.
...
1. Go to [nettrades/nettrades-platform](https://github.com/nettrades/nettrades-platform).
