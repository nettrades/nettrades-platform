...
- You must review the output and are fully responsible for its accuracy, quality, and originality.
- You must disclose such use to the Project at the time of submission.
- You must ensure that the terms of any AI tools used do not prohibit or restrict the use of the tool's output in a way that is inconsistent with the CLA.

**All contributors must sign our CLA before their pull request can be merged.**

When you open your first pull request, the **CLA Assistant bot** will automatically comment with a link to sign the CLA. Click the link, read the agreement, fill in the fields, and click "I agree" to sign.
...
Follow the [Developer Getting Started Guide](docs/developer/getting-started.md).
...
### 4. Make Your Changes
Follow the [Style Guide](docs/developer/style-guide.md).

### 5. Write Tests
Include unit or integration tests for your changes.

### 6. Update Documentation
If your change affects user-facing functionality, update the relevant documentation.

### 7. Open a Pull Request
Describe your changes and link any related issues. The CLA Assistant bot will check if you have signed the CLA.
...
2. CLA check runs — if not signed, bot prompts you to sign.
3. Maintainer reviews -> may request changes.
4. PR approved -> merged into `main`.
